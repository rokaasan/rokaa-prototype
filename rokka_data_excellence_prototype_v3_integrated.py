...
# --- KYC SECTION ---
st.subheader("🔍 Help us understand your business")
...
# --- ASSESSMENT SECTION ---
st.subheader("📊 Data Maturity Assessment")
...
recommendations = [
    {
        ...
        "recommendation": "Establish a data governance framework and assign data stewards.",
        "benefit": "Ensures accountability and consistency across data use."
    },
    {
        "area": "Data Quality",
        "recommendation": "Implement automated data quality checks.",
        "benefit": "Improves trust in data-driven decisions."
    },
    {
        "area": "Literacy",
        "recommendation": "Deliver targeted training for business users and analysts.",
        "benefit": "Builds a data-driven culture and increases adoption of analytics."
    }
]
for rec in recommendations:
    st.markdown(f"**🔹 {rec['area']}**")
    st.write(f"- **What to do**: {rec['recommendation']}")
    st.write(f"- **Why**: {rec['benefit']}")
    st.markdown("---")
...
roadmap = {
    "0–3 months (Quick Wins)": [
        ...
        "Run initial literacy training",
        "Document key data assets"
    ],
    "4–9 months (Foundation Building)": [
        "Implement data governance policies",
        "Deploy quality monitoring tools",
        "Centralize core datasets"
    ],
    "10–18 months (Strategic Growth)": [
        "Enable self-service BI",
        "Launch AI use cases",
        "Evaluate cloud data platform options"
    ]
}
